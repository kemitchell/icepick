...
These terms ensure each user's right to them same control they would enjoy running this software for themself when they instead rely on others to run it for them.  In using this software, you must respect that right for others, as they must respect it for you:
